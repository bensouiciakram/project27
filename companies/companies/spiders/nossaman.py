...
class SkaddenSpider(scrapy.Spider):
    name = 'nossaman'
    allowed_domains = ['nossaman.com']
    start_urls = ['https://www.nossaman.com/professionals-directory#form-search-results']
    ...
    def parse_individual(self,response):
        ...
        loader.add_value('firm_bio','https://www.nossaman.com/about-what-sets-us-apart')
