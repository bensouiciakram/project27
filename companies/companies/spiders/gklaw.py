...
class SkaddenSpider(scrapy.Spider):
    name = 'gklaw'
    allowed_domains = ['gklaw.com']
    start_urls = ['https://www.gklaw.com/Our-People.htm']
    ...
    def parse_individual(self,response):
        ...
        loader.add_value('firm_bio','https://www.gklaw.com/About.htm')
        loader.add_css('office','div.mainOffice::text')
