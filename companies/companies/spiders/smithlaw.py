...
class SkaddenSpider(scrapy.Spider):
    name = 'smithlaw'
    allowed_domains = ['smithlaw.com']
    start_urls = ['https://www.smithlaw.com/professionals-directory?results#content']

    def __init__(self):
        self.not_names = ['T.G.','J.P.','Jr.','V','III','M.','II','J.','W.','R.','AICP','G.','IV','W.F.','D.','S.','R.','W.','C.','Dr.','F.','A.','P.'] \
    ...
    def parse_individual(self,response):
        ...
        loader.add_value('email',response.xpath('//a[@title="Email"]/@href').get().replace('mailto:',''))
        ...
        loader.add_value('firm_bio','https://www.smithlaw.com/firm')
        loader.add_css('office','div.bioOffice>a::text')
