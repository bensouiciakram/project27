...
class SkaddenSpider(scrapy.Spider):
    name = 'msk'
    allowed_domains = ['msk.com']
    start_urls = ['https://www.msk.com/attorneys-alphabetical']
    ...
    def parse_individual(self,response):
        ...
        loader.add_xpath('email','//a[contains(@href,"@msk.com")]/text()')
        ...
        loader.add_value('firm_bio','https://www.msk.com/about')
        loader.add_css('office','div#bioTitle a::text')
