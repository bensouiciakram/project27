...
class SkaddenSpider(scrapy.Spider):
    name = 'constangy'
    allowed_domains = ['constangy.com']
    start_urls = ['https://www.constangy.com/people-directory']
    ...
    def parse_individual(self,response):
        ...
        loader.add_css('email','a[title=Email]::text')
        ...
        loader.add_value('firm_bio','https://www.constangy.com/firm')
