...
class SkaddenSpider(scrapy.Spider):
    name = 'kmclaw'
    allowed_domains = ['kmclaw.com']
    start_urls = ['https://www.kmclaw.com/professionals-attorneys']
    ...
    def parse_individual(self,response):
        ...
        loader.add_xpath('email','//a[contains(@href,"@kmclaw.com")]/span/text()')
        ...
        loader.add_value('firm_bio','https://www.kmclaw.com/about-about')
        loader.add_xpath('office','//a[contains(@href,"contact")]/span/text()')
