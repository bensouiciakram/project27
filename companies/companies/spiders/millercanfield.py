...
class MillercanfieldSpider(scrapy.Spider):
    name = 'millercanfield'
    allowed_domains = ['millercanfield.com']
    start_urls = ['https://www.millercanfield.com/people-staff.html?do_item_search=1']
    ...
    def parse(self, response):
        people_urls = [response.urljoin(url) for url in response.css('span.title a::attr(href)').getall()]
