...
class SkaddenSpider(scrapy.Spider):
    name = 'swiftcurrie'
    allowed_domains = ['swiftcurrie.com']
    start_urls = ['https://www.swiftcurrie.com/attorneys-directory']
    ...
    def parse_individual(self,response):
        ...
        try : 
            ...
            pass
        loader.add_css('image','div#bioPhoto img::attr(src)')
        loader.add_xpath('bio','string(//div[@id="bio_content"])')
        loader.add_value('firm_bio','https://www.swiftcurrie.com/about-litigators-at-heart')
