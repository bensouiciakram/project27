...
class SkaddenSpider(scrapy.Spider):
    name = 'schwabe'
    allowed_domains = ['schwabe.com']
    start_urls = ['https://www.schwabe.com/attorneys.html?do_item_search=1']
    ...
    def parse_individual(self,response):
        ...
        educations_list = [edu.xpath('string(.)').get() for edu in response.xpath('//h2[contains(text(),"Edu")]/following-sibling::div//li')]
        try :
        ...
        loader.add_value('firm_bio','https://www.schwabe.com/about')
