...
class SkaddenSpider(scrapy.Spider):
    name = 'connellfoley'
    allowed_domains = ['connellfoley.com']
    start_urls = ['https://www.connellfoley.com/professionals-directory']
    ...
    def parse(self, response):
        people_urls = [response.urljoin(url) for url in response.css('td.nametitle div.title a::attr(href)').getall()]
    ...
    def parse_individual(self,response):
        ...
        loader.add_value('firm_bio','https://www.connellfoley.com/about')
        loader.add_xpath('office','//ul[@id="bioPhone"]/li[1]/a/text()')
