...
class SkaddenSpider(scrapy.Spider):
    name = 'plunkettcooney'
    allowed_domains = ['plunkettcooney.com']
    start_urls = ['https://www.plunkettcooney.com/team#form-search-results']
    ...
    def parse(self, response):
        people_urls = [response.urljoin(url) for url in response.css('div.results_list>div>a::attr(href)').getall()]
    ...
    def parse_individual(self,response):
        ...
        loader.add_value('firm_bio','https://www.plunkettcooney.com/firm-what-sets-us-apart')
        loader.add_css('office','li.bioOfficeLink a::text')
