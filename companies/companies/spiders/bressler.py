...
class SkaddenSpider(scrapy.Spider):
    name = 'bressler'
    allowed_domains = ['bressler.com']
    start_urls = ['https://www.bressler.com/people-attorneys']
    ...
    def parse_individual(self,response):
        ...
        loader.add_value('firm_bio','https://www.bressler.com/about-who-we-are')
        loader.add_xpath('office','string(//ul[@id="bioOffices"])')
